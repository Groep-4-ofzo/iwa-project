...
<div class="max-w-3xl mx-auto">
    ...
    <h1 class="text-4xl font-bold mb-8">Startpagina</h1>
    ...
    <div class="bg-white p-6 rounded-lg shadow">
        ...
        <ul class="space-y-2">
            ...
            <li>
                <a href="{{ route('login') }}"
                   class="block p-3 rounded bg-white hover:bg-gray-200 transition">
                    Login
                </a>
            </li>
            @endguest
            ...
            <li>
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button
                        class="block w-full text-left p-3 rounded bg-white hover:bg-gray-100 transition">
                        Logout
                    </button>
                </form>
            </li>
